  ...
  return (
    <div>
      <Link href={`/report/create`}>
        <Button className="border border-emerald-600 py-1.5 bg-white w-full mb-4 opacity-70 hover:opacity-100 dark:bg-dark-card-background dark:border-gray-600">
          <PlusIcon className="size-10 w-full dark:text-slate-100" />
        </Button>
      </Link>
